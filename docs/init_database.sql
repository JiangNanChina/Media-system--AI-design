...
INSERT INTO site_configs (
    ...
    ('mail.duty_reminder_enabled', 'true', '执勤提醒开关', 'BOOLEAN', b'1', 1009, b'0'),
    ('mail.checkin_reminder_enabled', 'true', '晚自习打卡提醒开关', 'BOOLEAN', b'1', 1010, b'0'),
    ('mail.leave_approval_reminder_enabled', 'true', '请假审批提醒开关', 'BOOLEAN', b'1', 1011, b'0'),
    ('mail.borrow_overdue_reminder_enabled', 'true', '设备逾期归还提醒开关', 'BOOLEAN', b'1', 1012, b'0'),
