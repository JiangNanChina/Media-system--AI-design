...
BEGIN
    ...
    ELSE
        SELECT '⚠️ audit_status 字段已存在，跳过' AS result;
    END IF;
END$$
...
BEGIN
    ...
    ELSE
        SELECT '⚠️ audited_by 字段已存在，跳过' AS result;
    END IF;
END$$
...
BEGIN
    ...
    ELSE
        SELECT '⚠️ audit_time 字段已存在，跳过' AS result;
    END IF;
END$$
...
BEGIN
    ...
    ELSE
        SELECT '⚠️ audit_notes 字段已存在，跳过' AS result;
    END IF;
END$$
